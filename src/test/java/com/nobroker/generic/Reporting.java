...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		extent.setSystemInfo("user name","rajeshthakur1r@gmail.com");
		
		htmlReporter.config().setDocumentTitle("Nobroker Assignement Autogenerated report "); // Tile of report
		htmlReporter.config().setReportName("Functional Test Automation For Nobroker Android App"); // name of the report
